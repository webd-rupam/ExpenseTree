  ...
  return (
    <div className='w-full min-h-[51vh] overflow-x-hidden flex flex-col justify-between md:pt-20 pt-16 px-6 md:px-20 lg:px-40 bg-black text-white relative z-10'>
       ...
       <div className='w-full md:w-1/2 lg:w-1/3 mb-6 md:mb-0'>
         <h4 className='text-xl font-bold'>ExpenseTree</h4>
         <p className='text-sm mt-4 md:mt-6 mb-6 lg:mr-10'>
         ExpenseTree helps you seamlessly track and manage your finances with ease and precision. Whether budgeting for goals or monitoring daily expenses. It provides you with clear insights in a secure, user-friendly environment. Take charge of your financial journey today!
         </p>
       </div>
...
<div className='flex justify-around'>
       ...
       <p className='text-[11.5px] text-center mt-8 md:mt-0 mb-10 md:mb-8'>&copy; Copyright {currentYear} ExpenseTree . Made by <a className='underline' href='https://portfoliodekho.vercel.app' target="_blank">Webd Rupam</a></p>
